...
const logoutUser = asyncHandler(async(req, res) => {
    ...
    .json(
        new ApiResponse(new ApiResponse(200, {}, "User logged Out"))
...
const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const {accessToken, refreshAccessToken} = await generateAccessAndRefereshTokens(user._id)
        return res.status(200).cookie("accessToken", ac).cookie("refreshToken").json(
            new ApiResponse(
                200,
                {accessToken, refreshToken, newRefrshToken},
